...
public class WebDriverUtility {
    ...
    public WebDriverUtility navigateToApp(String browser,String url,long time) {
    	switch (browser) {
		case "chrome":
    ...
    public void selectFromdropdown(WebElement elemnt, String value) {
    ...
    public void switvhtoFrame(String idOrName) {
		driver.switchTo().frame(idOrName);
	}
    public void swichToframe(WebElement frameelement) {
